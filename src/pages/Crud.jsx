                      ...
                      {propiedades.length > 0 ? (
                        propiedades.map((prop) => (
                          ...
                          >
                            <Box
                              as="td"
                              class="p-2 flex text-left items-center whitespace-nowrap h-[52px] max-w-[250px] truncate text-[14px] text-black"
                              className="p-2"
                            >
                              {prop.titulo}
                            </Box>
                            <Box
                              as="td"
                              class="text-left p-2 h-[52px] text-[14px] text-black"
                            >
                              {prop.direccion}
                            </Box>
                            <Box
                              as="td"
                              class="text-left p-2 h-[52px] text-[14px] "
                            >
                              <Box
                                as="span"
